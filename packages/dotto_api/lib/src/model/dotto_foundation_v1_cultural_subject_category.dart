...
class DottoFoundationV1CulturalSubjectCategory extends EnumClass {
  ...
  static const DottoFoundationV1CulturalSubjectCategory communication =
      _$communication;

  static Serializer<DottoFoundationV1CulturalSubjectCategory> get serializer =>
      _$dottoFoundationV1CulturalSubjectCategorySerializer;

  const DottoFoundationV1CulturalSubjectCategory._(String name) : super(name);

  static BuiltSet<DottoFoundationV1CulturalSubjectCategory> get values =>
      _$values;
  static DottoFoundationV1CulturalSubjectCategory valueOf(String name) =>
      _$valueOf(name);
}
...
abstract class DottoFoundationV1CulturalSubjectCategoryMixin = Object
    with _$DottoFoundationV1CulturalSubjectCategoryMixin;
