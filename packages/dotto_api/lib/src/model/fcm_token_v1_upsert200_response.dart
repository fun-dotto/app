...
/// * [fcmToken]
@BuiltValue()
abstract class FCMTokenV1Upsert200Response
    implements
        Built<FCMTokenV1Upsert200Response, FCMTokenV1Upsert200ResponseBuilder> {
  @BuiltValueField(wireName: r'fcmToken')
  FCMToken get fcmToken;

  FCMTokenV1Upsert200Response._();

  factory FCMTokenV1Upsert200Response([
    void updates(FCMTokenV1Upsert200ResponseBuilder b),
  ]) = _$FCMTokenV1Upsert200Response;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(FCMTokenV1Upsert200ResponseBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<FCMTokenV1Upsert200Response> get serializer =>
      _$FCMTokenV1Upsert200ResponseSerializer();
}

class _$FCMTokenV1Upsert200ResponseSerializer
    implements PrimitiveSerializer<FCMTokenV1Upsert200Response> {
  @override
