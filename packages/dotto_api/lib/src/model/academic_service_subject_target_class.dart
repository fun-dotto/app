...
@BuiltValue()
abstract class AcademicServiceSubjectTargetClass
    implements
        Built<
          AcademicServiceSubjectTargetClass,
          AcademicServiceSubjectTargetClassBuilder
        > {
  ...
  factory AcademicServiceSubjectTargetClass([
    void updates(AcademicServiceSubjectTargetClassBuilder b),
  ]) = _$AcademicServiceSubjectTargetClass;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(AcademicServiceSubjectTargetClassBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<AcademicServiceSubjectTargetClass> get serializer =>
      _$AcademicServiceSubjectTargetClassSerializer();
}

class _$AcademicServiceSubjectTargetClassSerializer
    implements PrimitiveSerializer<AcademicServiceSubjectTargetClass> {
  @override
